...
use App\Filament\Clusters\SuratKeluar\Resources\SuratPtpnOutResource\Pages;
use App\Filament\Clusters\SuratKeluar\Resources\SuratPtpnOutResource\RelationManagers;
...
class SuratPtpnOutResource extends Resource
{
    protected static ?string $model = SuratPtpnOut::class;
    ...
    protected static ?string $navigationLabel = 'Surat PTPN Group';

    protected static ?string $pluralModelLabel = 'Surat PTPN Group';

    protected static ?string $modelLabel = 'Surat PTPN Group';
    ...
    {
        return [
            'index' => Pages\ListSuratPtpnOuts::route('/'),
            'create' => Pages\CreateSuratPtpnOut::route('/create'),
            'edit' => Pages\EditSuratPtpnOut::route('/{record}/edit'),
        ];
    }
}
