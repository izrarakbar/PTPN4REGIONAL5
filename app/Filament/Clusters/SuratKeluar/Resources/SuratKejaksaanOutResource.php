...
namespace App\Filament\Clusters\SuratKeluar\Resources;

use App\Filament\Clusters\SuratKeluar;
use App\Filament\Clusters\SuratKeluar\Resources\SuratKejaksaanOutResource\Pages;
use App\Filament\Clusters\SuratKeluar\Resources\SuratKejaksaanOutResource\RelationManagers;
use App\Models\SuratKejakasaanOut;
use App\Models\SuratKejaksaanOut;
use Filament\Forms;
...
class SuratKejaksaanOutResource extends Resource
{
    protected static ?string $model = SuratKejakasaanOut::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $cluster = SuratKeluar::class;

    protected static ?string $navigationGroup = 'Surat Eksternal';

    protected static ?string $navigationLabel = 'Surat Kejaksaan';

    protected static ?string $pluralModelLabel = 'Surat Kejaksaan';

    protected static ?string $modelLabel = 'Surat Kejaksaan';
    ...
    {
        return [
            'index' => Pages\ListSuratKejaksaanOuts::route('/'),
            'create' => Pages\CreateSuratKejaksaanOut::route('/create'),
            'edit' => Pages\EditSuratKejaksaanOut::route('/{record}/edit'),
        ];
    }
}
