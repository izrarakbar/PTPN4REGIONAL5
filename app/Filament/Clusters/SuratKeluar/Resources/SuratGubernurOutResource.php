...
use App\Filament\Clusters\SuratKeluar\Resources\SuratGubernurOutResource\Pages;
use App\Filament\Clusters\SuratKeluar\Resources\SuratGubernurOutResource\RelationManagers;
...
class SuratGubernurOutResource extends Resource
{
    protected static ?string $model = SuratGubernurOut::class;
    ...
    protected static ?string $navigationLabel = 'Surat Gubernur';

    protected static ?string $pluralModelLabel = 'Surat Gubernur';

    protected static ?string $modelLabel = 'Surat Gubernur';
    ...
    {
        return [
            'index' => Pages\ListSuratGubernurOuts::route('/'),
            'create' => Pages\CreateSuratGubernurOut::route('/create'),
            'edit' => Pages\EditSuratGubernurOut::route('/{record}/edit'),
        ];
    }
}
