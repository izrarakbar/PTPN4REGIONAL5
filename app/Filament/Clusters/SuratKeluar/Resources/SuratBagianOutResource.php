...
use App\Filament\Clusters\SuratKeluar\Resources\SuratBagianOutResource\Pages;
use App\Filament\Clusters\SuratKeluar\Resources\SuratBagianOutResource\RelationManagers;
...
class SuratBagianOutResource extends Resource
{
    protected static ?string $model = SuratBagianOut::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $cluster = SuratKeluar::class;

    protected static ?string $navigationGroup = 'Surat Internal';

    protected static ?string $navigationLabel = 'Surat Bagian';

    protected static ?string $pluralModelLabel = 'Surat Bagian';

    protected static ?string $modelLabel = 'Surat Bagian';
    ...
    {
        return [
            'index' => Pages\ListSuratBagianOuts::route('/'),
            'create' => Pages\CreateSuratBagianOut::route('/create'),
            'edit' => Pages\EditSuratBagianOut::route('/{record}/edit'),
        ];
    }
}
