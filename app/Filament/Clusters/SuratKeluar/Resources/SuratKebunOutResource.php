...
use App\Filament\Clusters\SuratKeluar\Resources\SuratKebunOutResource\Pages;
use App\Filament\Clusters\SuratKeluar\Resources\SuratKebunOutResource\RelationManagers;
...
class SuratKebunOutResource extends Resource
{
    protected static ?string $model = SuratKebunOut::class;
    ...
    protected static ?string $navigationLabel = 'Surat Kebun';

    protected static ?string $pluralModelLabel = 'Surat Kebun';

    protected static ?string $modelLabel = 'Surat Kebun';
    ...
    {
        return [
            'index' => Pages\ListSuratKebunOuts::route('/'),
            'create' => Pages\CreateSuratKebunOut::route('/create'),
            'edit' => Pages\EditSuratKebunOut::route('/{record}/edit'),
        ];
    }
}
