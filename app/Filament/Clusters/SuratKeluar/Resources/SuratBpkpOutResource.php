...
use App\Filament\Clusters\SuratKeluar\Resources\SuratBpkpOutResource\Pages;
use App\Filament\Clusters\SuratKeluar\Resources\SuratBpkpOutResource\RelationManagers;
...
class SuratBpkpOutResource extends Resource
{
    protected static ?string $model = SuratBpkpOut::class;
    ...
    protected static ?string $navigationLabel = 'Surat BPKP';

    protected static ?string $pluralModelLabel = 'Surat BPKP';

    protected static ?string $modelLabel = 'Surat BPKP';
    ...
    {
        return [
            'index' => Pages\ListSuratBpkpOuts::route('/'),
            'create' => Pages\CreateSuratBpkpOut::route('/create'),
            'edit' => Pages\EditSuratBpkpOut::route('/{record}/edit'),
        ];
    }
}
