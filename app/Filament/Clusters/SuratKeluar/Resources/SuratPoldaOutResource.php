...
use App\Filament\Clusters\SuratKeluar\Resources\SuratPoldaOutResource\Pages;
use App\Filament\Clusters\SuratKeluar\Resources\SuratPoldaOutResource\RelationManagers;
...
class SuratPoldaOutResource extends Resource
{
    protected static ?string $model = SuratPoldaOut::class;
    ...
    protected static ?string $navigationLabel = 'Surat POLDA';

    protected static ?string $pluralModelLabel = 'Surat POLDA';

    protected static ?string $modelLabel = 'Surat POLDA';
    ...
    {
        return [
            'index' => Pages\ListSuratPoldaOuts::route('/'),
            'create' => Pages\CreateSuratPoldaOut::route('/create'),
            'edit' => Pages\EditSuratPoldaOut::route('/{record}/edit'),
        ];
    }
}
