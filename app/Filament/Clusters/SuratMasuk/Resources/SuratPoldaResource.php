...
use App\Filament\Clusters\SuratMasuk\Resources\SuratPoldaResource\Pages;
use App\Filament\Clusters\SuratMasuk\Resources\SuratPoldaResource\RelationManagers;
...
class SuratPoldaResource extends Resource
{
    protected static ?string $model = SuratPolda::class;
    ...
    {
        return [
            'index' => Pages\ListSuratPoldas::route('/'),
            'create' => Pages\CreateSuratPolda::route('/create'),
            'edit' => Pages\EditSuratPolda::route('/{record}/edit'),
        ];
    }
}
