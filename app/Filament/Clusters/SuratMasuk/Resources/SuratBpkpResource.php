...
use App\Filament\Clusters\SuratMasuk\Resources\SuratBpkpResource\Pages;
use App\Filament\Clusters\SuratMasuk\Resources\SuratBpkpResource\RelationManagers;
...
class SuratBpkpResource extends Resource
{
    protected static ?string $model = SuratBpkp::class;
    ...
    {
        return [
            'index' => Pages\ListSuratBpkps::route('/'),
            'create' => Pages\CreateSuratBpkp::route('/create'),
            'edit' => Pages\EditSuratBpkp::route('/{record}/edit'),
        ];
    }
}
