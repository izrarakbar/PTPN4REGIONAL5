...
use App\Filament\Clusters\SuratMasuk\Resources\SuratKebunResource\Pages;
use App\Filament\Clusters\SuratMasuk\Resources\SuratKebunResource\RelationManagers;
...
class SuratKebunResource extends Resource
{
    protected static ?string $model = SuratKebun::class;
    ...
    {
        return [
            'index' => Pages\ListSuratKebuns::route('/'),
            'create' => Pages\CreateSuratKebun::route('/create'),
            'edit' => Pages\EditSuratKebun::route('/{record}/edit'),
        ];
    }
}
