...
use App\Filament\Clusters\SuratMasuk\Resources\SuratGubernurResource\Pages;
use App\Filament\Clusters\SuratMasuk\Resources\SuratGubernurResource\RelationManagers;
...
class SuratGubernurResource extends Resource
{
    protected static ?string $model = SuratGubernur::class;
    ...
    {
        return [
            'index' => Pages\ListSuratGubernurs::route('/'),
            'create' => Pages\CreateSuratGubernur::route('/create'),
            'edit' => Pages\EditSuratGubernur::route('/{record}/edit'),
        ];
    }
}
