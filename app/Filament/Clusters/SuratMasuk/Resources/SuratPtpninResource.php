...
use App\Filament\Clusters\SuratMasuk\Resources\SuratPtpninResource\Pages;
use App\Filament\Clusters\SuratMasuk\Resources\SuratPtpninResource\RelationManagers;
...
class SuratPtpninResource extends Resource
{
    protected static ?string $model = SuratPtpnin::class;
    ...
    {
        return [
            'index' => Pages\ListSuratPtpnins::route('/'),
            'create' => Pages\CreateSuratPtpnin::route('/create'),
            'edit' => Pages\EditSuratPtpnin::route('/{record}/edit'),
        ];
    }
}
