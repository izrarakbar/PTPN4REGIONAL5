...
use App\Filament\Clusters\SuratMasuk\Resources\SuratBagianResource\Pages;
use App\Filament\Clusters\SuratMasuk\Resources\SuratBagianResource\RelationManagers;
...
class SuratBagianResource extends Resource
{
    protected static ?string $model = SuratBagian::class;
    ...
    {
        return [
            'index' => Pages\ListSuratBagians::route('/'),
            'create' => Pages\CreateSuratBagian::route('/create'),
            'edit' => Pages\EditSuratBagian::route('/{record}/edit'),
        ];
    }
}
