...
namespace App\Filament\Clusters\SuratMasuk\Resources;

use App\Filament\Clusters\SuratMasuk;
use App\Filament\Clusters\SuratMasuk\Resources\SuratKejaksaanResource\Pages;
use App\Filament\Clusters\SuratMasuk\Resources\SuratKejaksaanResource\RelationManagers;
use App\Models\SuratKejakasaan;
use App\Models\SuratKejaksaan;
use Filament\Forms;
...
class SuratKejaksaanResource extends Resource
{
    protected static ?string $model = SuratKejakasaan::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $cluster = SuratMasuk::class;
    ...
    {
        return [
            'index' => Pages\ListSuratKejaksaans::route('/'),
            'create' => Pages\CreateSuratKejaksaan::route('/create'),
            'edit' => Pages\EditSuratKejaksaan::route('/{record}/edit'),
        ];
    }
}
