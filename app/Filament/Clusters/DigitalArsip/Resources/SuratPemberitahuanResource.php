...
use App\Filament\Clusters\DigitalArsip\Resources\SuratPemberitahuanResource\Pages;
use App\Filament\Clusters\DigitalArsip\Resources\SuratPemberitahuanResource\RelationManagers;
...
class SuratPemberitahuanResource extends Resource
{
    protected static ?string $model = SuratPemberitahuan::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $cluster = DigitalArsip::class;

    protected static ?string $navigationLabel = 'Surat Pemberitahuan';

    protected static ?string $pluralModelLabel = 'Surat Pemberitahuan';

    protected static ?string $modelLabel = 'Surat Pemberitahuan';
        ...
        return $form
            ->schema([
                ...
                Forms\Components\FileUpload::make('file')
                    ...
                    ->maxSize(102400), // Batasan ukuran file hingga 100MB
            ]);
    }
    ...
    {
        return [
            'index' => Pages\ListSuratPemberitahuans::route('/'),
            'create' => Pages\CreateSuratPemberitahuan::route('/create'),
            'edit' => Pages\EditSuratPemberitahuan::route('/{record}/edit'),
        ];
    }
}
