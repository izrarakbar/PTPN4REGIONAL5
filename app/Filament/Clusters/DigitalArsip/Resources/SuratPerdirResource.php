...
use App\Filament\Clusters\DigitalArsip\Resources\SuratPerdirResource\Pages;
use App\Filament\Clusters\DigitalArsip\Resources\SuratPerdirResource\RelationManagers;
...
class SuratPerdirResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Surat PERDIR';

    protected static ?string $modelLabel = 'Surat PERDIR';
