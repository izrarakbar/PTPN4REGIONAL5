...
use App\Filament\Clusters\DigitalArsip\Resources\SuratSeResource\Pages;
use App\Filament\Clusters\DigitalArsip\Resources\SuratSeResource\RelationManagers;
...
class SuratSeResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'Surat SE';

    protected static ?string $modelLabel = 'Surat SE';
