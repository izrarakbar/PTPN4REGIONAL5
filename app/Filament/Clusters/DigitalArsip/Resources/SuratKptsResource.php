...
use App\Filament\Clusters\DigitalArsip\Resources\SuratKptsResource\Pages;
use App\Filament\Clusters\DigitalArsip\Resources\SuratKptsResource\RelationManagers;
...
class SuratKptsResource extends Resource
{
    protected static ?string $model = SuratKpts::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $cluster = DigitalArsip::class;

    protected static ?string $navigationLabel = 'Surat KPTS';

    protected static ?string $pluralModelLabel = 'Surat KPTS';

    protected static ?string $modelLabel = 'Surat KPTS';
        ...
        return $form
            ->schema([
                ...
                Forms\Components\TextInput::make('judul')
                    ->required()
                    // ->reactive() // Ditambahkan agar reaktif
                    ->afterStateUpdated(fn($state, callable $set) => $set('ringkasan', $state)), // Mengisi 'ringkasan' otomatis dengan 'judul'
                ...
                Forms\Components\FileUpload::make('file')
                    ...
                    ->disk('public') // Set disk storage
                    ->preserveFilenames() // Menjaga nama file asli
                    ->visibility('public'), // Set visibilitas file
    ...
    {
        return [
            'index' => Pages\ListSuratKpts::route('/'),
            'create' => Pages\CreateSuratKpts::route('/create'),
            'edit' => Pages\EditSuratKpts::route('/{record}/edit'),
        ];
    }
}
