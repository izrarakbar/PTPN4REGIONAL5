...
use App\Filament\Clusters\DigitalArsip\Resources\SuratNotulenResource\Pages;
use App\Filament\Clusters\DigitalArsip\Resources\SuratNotulenResource\RelationManagers;
...
class SuratNotulenResource extends Resource
{
    protected static ?string $model = SuratNotulen::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $cluster = DigitalArsip::class;

    protected static ?string $navigationLabel = 'Surat Notulen';

    protected static ?string $pluralModelLabel = 'Surat Notulen';

    protected static ?string $modelLabel = 'Surat Notulen';
    ...
    {
        return [
            'index' => Pages\ListSuratNotulens::route('/'),
            'create' => Pages\CreateSuratNotulen::route('/create'),
            'edit' => Pages\EditSuratNotulen::route('/{record}/edit'),
        ];
    }
}
