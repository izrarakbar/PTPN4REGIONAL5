...
use App\Filament\Clusters\DigitalArsip\Resources\SuratPaktaResource\Pages;
use App\Filament\Clusters\DigitalArsip\Resources\SuratPaktaResource\RelationManagers;
...
class SuratPaktaResource extends Resource
{
    protected static ?string $model = SuratPakta::class;

    protected static ?string $navigationIcon = 'heroicon-o-rectangle-stack';

    protected static ?string $cluster = DigitalArsip::class;

    protected static ?string $navigationLabel = 'Surat Pakta Integritas';

    protected static ?string $pluralModelLabel = 'Surat Pakta Integritas';

    protected static ?string $modelLabel = 'Surat Pakta Integritas';
    ...
    {
        return [
            'index' => Pages\ListSuratPaktas::route('/'),
            'create' => Pages\CreateSuratPakta::route('/create'),
            'edit' => Pages\EditSuratPakta::route('/{record}/edit'),
        ];
    }
}
